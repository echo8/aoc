            ...
            for (int i = 0; i < layout.size(); i++) {
                ...
                for (int j = 0; j < layout.get(i).size(); j++) {
                    ...
                    if (layout.get(i).get(j) == 'L') {
                        int occ = 0;
                        if (i > 0 && j > 0 && layout.get(i-1).get(j-1) == '#') {
                            occ++;
                        }
                        if (i > 0 && layout.get(i-1).get(j) == '#') {
                            occ++;
                        }
                        if (i > 0 && j < layout.get(i-1).size()-1 && layout.get(i-1).get(j+1) == '#') {
                            occ++;
                        }
                        if (j > 0 && layout.get(i).get(j-1) == '#') {
                            occ++;
                        }
                        if (j < layout.get(i).size()-1 && layout.get(i).get(j+1) == '#') {
                            occ++;
                        }
                        if (i < layout.size()-1 && j > 0 && layout.get(i+1).get(j-1) == '#') {
                            occ++;
                        }
                        if (i < layout.size()-1 && layout.get(i+1).get(j) == '#') {
                            occ++;
                        }
                        if (i < layout.size()-1 && j < layout.get(i+1).size()-1 && layout.get(i+1).get(j+1) == '#') {
                            occ++;
                        }
                        if (occ == 0) {
                            next = '#';
